-- ==============================================================================
	...
	-- ==============================================================================
	-- 1. TABELA ENDERECO
	INSERT INTO ENDERECO (id_endereco, rua, numero, cidade, estado, cep, complemento) VALUES
	...
	-- 2. TABELA USUARIO
	INSERT INTO USUARIO (id_usuario, nome_completo, telefone, cpf, email, cargo, senha, data_nascimento) VALUES
	('11111111-1111-1111-1111-000000000001', 'Ana Silva', '11988887701', '12345678901', 'ana.silva@email.com', 'Veterinário', crypt('senha123', gen_salt('bf', 12)), '1990-05-12'),
	('11111111-1111-1111-1111-000000000002', 'Bruno Costa', '11988887702', '12345678902', 'bruno.costa@email.com', 'Gerente', crypt('senha123', gen_salt('bf', 12)), '1985-08-20'),
	('11111111-1111-1111-1111-000000000003', 'Carlos Eduardo', '11988887703', '12345678903', 'carlos.eduardo@email.com', 'Zootecnista', crypt('senha123', gen_salt('bf', 12)), '1992-03-15'),
	('11111111-1111-1111-1111-000000000004', 'Daniela Rocha', '11988887704', '12345678904', 'daniela.rocha@email.com', 'Veterinário', crypt('senha123', gen_salt('bf', 12)), '1994-11-02'),
	('11111111-1111-1111-1111-000000000005', 'Eduardo Lima', '11988887705', '12345678905', 'eduardo.lima@email.com', 'Capataz', crypt('senha123', gen_salt('bf', 12)), '1988-01-30'),
	('11111111-1111-1111-1111-000000000006', 'Fernanda Souza', '11988887706', '12345678906', 'fernanda.souza@email.com', 'Administrador de Campo', crypt('senha123', gen_salt('bf', 12)), '1996-07-22'),
	('11111111-1111-1111-1111-000000000007', 'Gabriel Alves', '11988887707', '12345678907', 'gabriel.alves@email.com', 'Tratorista', crypt('senha123', gen_salt('bf', 12)), '1991-09-10'),
	('11111111-1111-1111-1111-000000000008', 'Helena Martins', '11988887708', '12345678908', 'helena.martins@email.com', 'Veterinário', crypt('senha123', gen_salt('bf', 12)), '1993-04-18'),
	('11111111-1111-1111-1111-000000000009', 'Igor Ferreira', '11988887709', '12345678909', 'igor.ferreira@email.com', 'Auxiliar de Manejo', crypt('senha123', gen_salt('bf', 12)), '1998-12-05'),
	('11111111-1111-1111-1111-000000000010', 'Juliana Paes', '11988887710', '12345678910', 'juliana.paes@email.com', 'Supervisora', crypt('senha123', gen_salt('bf', 12)), '1987-06-14'),
	('11111111-1111-1111-1111-000000000011', 'Lucas Mendes', '11988887711', '12345678911', 'lucas.mendes@email.com', 'Gerente', crypt('senha123', gen_salt('bf', 12)), '1983-02-28'),
	('11111111-1111-1111-1111-000000000012', 'Mariana Oliveira', '11988887712', '12345678912', 'mariana.oliveira@email.com', 'Zootecnista', crypt('senha123', gen_salt('bf', 12)), '1995-10-08'),
	('11111111-1111-1111-1111-000000000013', 'Nicolas Santos', '11988887713', '12345678913', 'nicolas.santos@email.com', 'Auxiliar de Manejo', crypt('senha123', gen_salt('bf', 12)), '1999-03-25'),
	('11111111-1111-1111-1111-000000000014', 'Patricia Ribeiro', '11988887714', '12345678914', 'patricia.ribeiro@email.com', 'Veterinário', crypt('senha123', gen_salt('bf', 12)), '1991-01-19'),
	('11111111-1111-1111-1111-000000000015', 'Rafael Barbosa', '11988887715', '12345678915', 'rafael.barbosa@email.com', 'Capataz', crypt('senha123', gen_salt('bf', 12)), '1989-07-04');

	-- 3. TABELA ADMIN
	INSERT INTO ADMIN (nome_completo, cpf, email, telefone, senha) VALUES
	...
	INSERT INTO PROPRIEDADE (id_propriedade, nome, cnpj, telefone, id_usuario, id_endereco) VALUES
	...
	-- 5. TABELA REBANHO
	INSERT INTO REBANHO (id_rebanho, nome, raca, finalidade, qtd_cabecas, id_propriedade) VALUES
	('33333333-3333-3333-3333-000000000001', 'Nelore Elite A', 'Nelore', 'Corte', 50, '22222222-2222-2222-2222-000000000001'),
	('33333333-3333-3333-3333-000000000002', 'Angus Premium', 'Angus', 'Corte', 40, '22222222-2222-2222-2222-000000000002'),
	('33333333-3333-3333-3333-000000000003', 'Gyr Corte', 'Gyr', 'Corte', 30, '22222222-2222-2222-2222-000000000003'),
	('33333333-3333-3333-3333-000000000004', 'Brahman Comercial', 'Brahman', 'Corte', 60, '22222222-2222-2222-2222-000000000004'),
	('33333333-3333-3333-3333-000000000005', 'Brangus Engorda', 'Brangus', 'Corte', 25, '22222222-2222-2222-2222-000000000005'),
	('33333333-3333-3333-3333-000000000006', 'Senepol Puro', 'Senepol', 'Corte', 35, '22222222-2222-2222-2222-000000000006'),
	('33333333-3333-3333-3333-000000000007', 'Girolando Recria', 'Girolando', 'Corte', 45, '22222222-2222-2222-2222-000000000007'),
	('33333333-3333-3333-3333-000000000008', 'Nelore Mocho', 'Nelore', 'Corte', 55, '22222222-2222-2222-2222-000000000008'),
	('33333333-3333-3333-3333-000000000009', 'Hereford Sul', 'Hereford', 'Corte', 20, '22222222-2222-2222-2222-000000000009'),
	('33333333-3333-3333-3333-000000000010', 'Wagyu Seleção', 'Wagyu', 'Corte', 15, '22222222-2222-2222-2222-000000000010'),
	('33333333-3333-3333-3333-000000000011', 'Tabapuã Nelore', 'Tabapuã', 'Corte', 30, '22222222-2222-2222-2222-000000000011'),
	('33333333-3333-3333-3333-000000000012', 'Holandês Machos Corte', 'Holandês (Corte)', 'Corte', 40, '22222222-2222-2222-2222-000000000012'),
	('33333333-3333-3333-3333-000000000013', 'Guzerá Rústico', 'Guzerá', 'Corte', 35, '22222222-2222-2222-2222-000000000013'),
	('33333333-3333-3333-3333-000000000014', 'Canchim Confinamento', 'Canchim', 'Corte', 50, '22222222-2222-2222-2222-000000000014'),
	('33333333-3333-3333-3333-000000000015', 'Santa Gertrudis', 'Santa Gertrudis', 'Corte', 28, '22222222-2222-2222-2222-000000000015');

	-- 6. TABELA LOTE 
	INSERT INTO LOTE (id_lote, codigo_lote, categoria, qtd_cabecas, data_abertura, id_rebanho) VALUES
	('55555555-5555-5555-5555-000000000001', 'LOTE-001', 'CRIA', 10, '2026-01-01', '33333333-3333-3333-3333-000000000001'),
	('55555555-5555-5555-5555-000000000002', 'LOTE-002', 'RECRIA', 12, '2026-01-01', '33333333-3333-3333-3333-000000000002'),
	('55555555-5555-5555-5555-000000000003', 'LOTE-003', 'ENGORDA', 15, '2026-01-05', '33333333-3333-3333-3333-000000000003'),
	('55555555-5555-5555-5555-000000000004', 'LOTE-004', 'RECRIA', 20, '2026-01-10', '33333333-3333-3333-3333-000000000004'),
	('55555555-5555-5555-5555-000000000005', 'LOTE-005', 'ENGORDA', 8, '2026-01-12', '33333333-3333-3333-3333-000000000005'),
	('55555555-5555-5555-5555-000000000006', 'LOTE-006', 'ENGORDA', 5, '2026-01-15', '33333333-3333-3333-3333-000000000006'),
	('55555555-5555-5555-5555-000000000007', 'LOTE-007', 'RECRIA', 14, '2026-01-20', '33333333-3333-3333-3333-000000000007'),
	('55555555-5555-5555-5555-000000000008', 'LOTE-008', 'ENGORDA', 25, '2026-01-22', '33333333-3333-3333-3333-000000000008'),
	('55555555-5555-5555-5555-000000000009', 'LOTE-009', 'CRIA', 10, '2026-02-01', '33333333-3333-3333-3333-000000000009'),
	('55555555-5555-5555-5555-000000000010', 'LOTE-010', 'ENGORDA', 15, '2026-02-03', '33333333-3333-3333-3333-000000000010'),
	('55555555-5555-5555-5555-000000000011', 'LOTE-011', 'RECRIA', 18, '2026-02-05', '33333333-3333-3333-3333-000000000011'),
	('55555555-5555-5555-5555-000000000012', 'LOTE-012', 'ENGORDA', 12, '2026-02-10', '33333333-3333-3333-3333-000000000012'),
	('55555555-5555-5555-5555-000000000013', 'LOTE-013', 'RECRIA', 16, '2026-02-12', '33333333-3333-3333-3333-000000000013'),
	('55555555-5555-5555-5555-000000000014', 'LOTE-014', 'ENGORDA', 22, '2026-02-15', '33333333-3333-3333-3333-000000000014'),
	('55555555-5555-5555-5555-000000000015', 'LOTE-015', 'RECRIA', 19, '2026-02-20', '33333333-3333-3333-3333-000000000015');

	-- 7. TABELA ANIMAL (com motivos de exceção clínicos/sanitários e datas inicial/final preenchidas)
	INSERT INTO ANIMAL (id_animal, brinco, peso, data_nascimento, motivo_excecao, data_inicio_excecao, data_fim_excecao, observacoes, id_lote) VALUES
	...
	INSERT INTO PERIODO_CARENCIA (id_carencia, data_inicio_carencia, data_fim_carencia, observacoes, id_animal) VALUES
	...
	-- 9. TABELA FORNECEDOR
	INSERT INTO FORNECEDOR (id_fornecedor, nome_completo, cnpj, telefone, email, id_endereco) VALUES
	...
	INSERT INTO MEDICAMENTO (id_medicamento, nome_comercial, dose, unidade_medida, principio_ativo, indicacao, carencia_indicada_dias, categoria_terapeutica, id_fornecedor) VALUES
	...
	INSERT INTO LOTE_MEDICAMENTO (id_lote_medicamento, lote_fabricacao, quantidade_inicial, data_fabricacao, data_validade, data_entrada, id_medicamento) VALUES
	...
	INSERT INTO ESTOQUE_MEDICAMENTO (id_estoque_medicamento, quantidade_disponivel, minimo_estoque, maximo_estoque, local_armazenamento, id_lote_medicamento) VALUES
	...
	-- 13. TABELA APLICACAO
	INSERT INTO APLICACAO (id_aplicacao, dose, unidade_medida, qtd_cabecas_aplicadas, via_administracao, membro_aplicacao, local_aplicacao, objetivo, data_hora, observacoes, id_usuario, id_lote_medicamento, id_lote) VALUES
	('ccccccc1-cccc-cccc-cccc-000000000001', 10.000, 'ml', 10, 'SUBCUTANEA', 'Pescoço', 'Curral Principal', 'Vermifugação de rotina', '2026-01-10 08:30:00', 'Animais responderam bem', '11111111-1111-1111-1111-000000000001', 'd1111111-1111-1111-1111-000000000001', '55555555-5555-5555-5555-000000000001'),
	...
	('ccccccc1-cccc-cccc-cccc-000000000004', 20.000, 'ml', 20, 'TOPICA', 'Dorso', 'Curral Principal', 'Banho de carrapaticida', '2026-01-18 10:15:00', 'Sucesso no manejo', '11111111-1111-1111-1111-000000000004', 'd1111111-1111-1111-1111-000000000004', '55555555-5555-5555-5555-000000000004'),
	('ccccccc1-cccc-cccc-cccc-000000000005', 10.000, 'ml', 8, 'SUBCUTANEA', 'Pescoço', 'Curral 2', 'Tratamento antibiótico', '2026-01-20 08:00:00', 'Lote monitorado', '11111111-1111-1111-1111-000000000005', 'd1111111-1111-1111-1111-000000000005', '55555555-5555-5555-5555-000000000005'),
	('ccccccc1-cccc-cccc-cccc-000000000006', 10.000, 'ml', 5, 'SUBCUTANEA', 'Pescoço', 'Curral Central', 'Desparasitação', '2026-01-25 11:30:00', 'Aplicação sem sobressaltos', '11111111-1111-1111-1111-000000000006', 'd1111111-1111-1111-1111-000000000006', '55555555-5555-5555-5555-000000000006'),
	...
	('ccccccc1-cccc-cccc-cccc-000000000008', 5.000, 'ml', 25, 'SUBCUTANEA', 'Pescoço', 'Confinamento A', 'Tratamento respiratório', '2026-02-01 14:00:00', 'Procedimento rápido', '11111111-1111-1111-1111-000000000008', 'd1111111-1111-1111-1111-000000000008', '55555555-5555-5555-5555-000000000008'),
	...
	('ccccccc1-cccc-cccc-cccc-000000000011', 2.000, 'ml', 18, 'SUBCUTANEA', 'Pescoço', 'Curral 1', 'Imunização vacinal', '2026-02-08 10:30:00', 'Campanha de vacinação', '11111111-1111-1111-1111-000000000011', 'd1111111-1111-1111-1111-000000000011', '55555555-5555-5555-5555-000000000011'),
	('ccccccc1-cccc-cccc-cccc-000000000012', 5.000, 'ml', 12, 'SUBCUTANEA', 'Pescoço', 'Curral 2', 'Vacinação de febre aftosa', '2026-02-10 11:00:00', 'Comprovante emitido', '11111111-1111-1111-1111-000000000012', 'd1111111-1111-1111-1111-000000000012', '55555555-5555-5555-5555-000000000012'),
	...
	('ccccccc1-cccc-cccc-cccc-000000000014', 15.000, 'ml', 22, 'TOPICA', 'Dorso', 'Confinamento B', 'Desparasitação Pour-On', '2026-02-15 08:50:00', 'Cobriu lote completo', '11111111-1111-1111-1111-000000000014', 'd1111111-1111-1111-1111-000000000014', '55555555-5555-5555-5555-000000000014'),
	('ccccccc1-cccc-cccc-cccc-000000000015', 50.000, 'ml', 19, 'INTRAVENOSA', 'Veia Jugular', 'Hospital da Fazenda', 'Suplementação emergencial', '2026-02-18 16:20:00', 'Evolução favorável', '11111111-1111-1111-1111-000000000015', 'd1111111-1111-1111-1111-000000000015', '55555555-5555-5555-5555-000000000015');
